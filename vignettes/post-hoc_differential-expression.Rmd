...
The confidence curves obtained by calibration of the Simes and Beta families can be compared graphically to the (parametric) Simes curve of @GS2011:

```{r, conf-env-plot}
confBounds <- lapply(resList, bound, all = TRUE)
cols <- RColorBrewer::brewer.pal(length(confBounds), "Dark2")
p <- plotConfCurve(confBounds, xmax = 300, cols = cols)
