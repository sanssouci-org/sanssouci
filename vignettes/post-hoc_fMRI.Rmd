...
We start by calculating the basic Simes bound introduced by Goeman and Solari (2011). This bounds has already been used for fMRI data, see @rosenblatt2018ari. In that paper, post hoc inference (by the Simes inequality) is referred to as "All-resolutions inference" (ARI).
