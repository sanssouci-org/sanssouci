...
- Post hoc bounds can be downloaded as CSV file. 
...
By default (i.e. when "Use public data" is checked), we consider a data set studied in @BGH2010.
...
- Uncheck "Use public data": you will be able to upload your own gene expression data, and optionally a file containing gene sets of interest (for example obtained from Gene Ontology). The data should be of the following form:
