...
> - Clicking on the line corresponding to GO a term highlights the corresponding genes in the volcano plot
> - Clicking on a GO term opens the associated QuickGO page (@binns2009quickgo), e.g. https://www.ebi.ac.uk/QuickGO/term/GO:0018108.
...
Both approaches are readily avialable via the drop-down menu, which makes it possible to display only those gene sets that are significant for the "self-contained" and "competitive" hypotheses. 
...
[1] Blanchard, Neuvial, and Roquain (2020). Annals of Statistics 48 (3): 1281–1303. https://projecteuclid.org/euclid.aos/1594972818.
[2] ---, (in press). Book chapter for Handbook of Multiple Comparisons (Springer). https://hal.archives-ouvertes.fr/hal-02320543.
[3] Goeman, and Solari. (2011). Statistical Science. https://projecteuclid.org/euclid.ss/1330437937
[4] Ebrahimpoor et. al. (2020). Briefings in Bioinformatics. https://academic.oup.com/bib/article/21/4/1302/5528235
