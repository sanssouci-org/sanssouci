...
author: "Guillermo Durand, Gilles Blanchard, Pierre Neuvial and Etienne Roquain"
date: today
format:
  html:
    toc: true
...
![Figure 11 in Durand et al.](DBNR_graph-simu.png){#fig-simulation-tree width="100%"}
...
```{r}
#| label: zoom-plot-confidence-curve
#| warning: false
