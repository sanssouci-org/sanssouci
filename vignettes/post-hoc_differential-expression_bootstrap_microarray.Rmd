...
These two confidence curves can be displayed on the same plot, allowing for direct comparison of the signal across multiple contrasts. In the example below, we can clearly observe that the signal associated with the `fev1_fvc_utah` variable is stronger than that of `age_enroll`.
