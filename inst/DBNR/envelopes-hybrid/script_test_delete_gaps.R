# delete.gaps is missing, couldn't find it
# may be from an old version of pruning that didn't delete gaps
# and needed delete.gaps on top of it
# may/should be deleted safely (?)
