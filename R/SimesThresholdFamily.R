...
##' thr <- sk(0.2)
##'
SimesThresholdFamily <- structure(function(
### Simes' threshold family
    m,
...
### k[max]}).
    )
   {
       ...
       return(sk)
### A threshold function (on the scale of test statistics) based on
### the classical family of thresholds introduced by Simes (1986):
### \eqn{\alpha*k/m}. This family yields joint FWER control at level
### (at most) \eqn{\alpha} if the test statistics are positively
